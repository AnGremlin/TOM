class SpencersExitBehavior extends Sup.Behavior {
  ...
  update() {
    if (this.actor.spriteRenderer.getAnimation() == "Animation" && ! this.actor.spriteRenderer.isAnimationPlaying()) {
      Game.cameraBehavior.transitionToScene("In-Game/Scenery/FruitRoom/Prefab", "Spencers Door");
    }
  }
...
Sup.registerBehavior(SpencersExitBehavior);
